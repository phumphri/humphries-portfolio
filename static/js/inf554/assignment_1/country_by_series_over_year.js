...
function draw_country_by_series_over_year(country) {
  ...
  console.log('function country_by_series_and_year.drawChar(' + selected_country + ') was called.')
  ...
  switch (selected_country) {
    ...
    case 'PE':
      country_name = 'Peru'
      ta02.innerHTML = 'Peru decreased exports and stocks to fill the difference between production and demand.'
      break
    case 'SU':
