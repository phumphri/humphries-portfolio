...
<script>
    ...
    export default {
        name: "TripsByYearMonth",
        props: ["row_id", "div_id", "parent_id", "csv_file"],
        ...
        mounted() {
            ...
            var var_csv_file = this.csv_file;

            // Row for locating the row title.
            var sans_row_id = this.row_id;
            ...
            d3.csv(var_csv_file, function (d) {
                ...
                function set_width_and_height() {
                    ...
                    if (g.bar_chart_div.empty()) {
                        d3.select("body")
                            .append("text")
                            .text("bar chart div was not found:  var_div_id:  " + var_div_id);
                        return;
                    }
